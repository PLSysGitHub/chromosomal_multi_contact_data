...
for contact_R in [100, 125, 150, 175, 200] #nm
    out_contacts="Contact_files/bintu_IMR90_contact_r_$contact_R.txt"
    out_triplets="Triplet_files/bintu_IMR90_contact_r_$contact_R.h5"
    ...
    @showprogress 1 "Analysing samples..." for cell in 0:num_cells-1
        ...
        ds=pairwise(Euclidean(),positions,dims=2)

        contacts[ds.<contact_R].+=1
        d_squared[.!isnan.(ds)].+=ds[.!isnan.(ds)].^2
        num_samples_2[.!isnan.(ds)].+=1
