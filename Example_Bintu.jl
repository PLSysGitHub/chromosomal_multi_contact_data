...
using Plots
gr(label="",size=(540,500), grid=false,
...
num_samp=1574
contact_file="./Contact_files/bintu_IMR90_test.txt"
P0_file="./Contact_files/P0_linear_n10_b119.27064620249611_N65_R7.021446824210077.txt"
triplet_file="./Triplet_files/bintu_IMR90_test.h5" #triplet file should contain 3D triplet frequency array as "triplets"
